/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3b410b7198a1f2c10b355d7566349b66)
// Runtime types generated with workerd@1.20260710.1 2026-07-17 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	EXPECTED_FORECAST_QUEUE: "earned-signal-staging-forecast-runs" | "earned-signal-production-forecast-runs" | "earned-signal-local-forecast-runs";
	EXPECTED_FORECAST_DLQ: "earned-signal-staging-forecast-runs-dlq" | "earned-signal-production-forecast-runs-dlq" | "earned-signal-local-forecast-runs-dlq";
	FORECAST_SIMULATOR: DurableObjectNamespace<import("./src/index").ForecastSimulatorContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ForecastSimulatorContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXPECTED_FORECAST_QUEUE" | "EXPECTED_FORECAST_DLQ">> {}
}
