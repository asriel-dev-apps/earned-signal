/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a3543234ad5419b426728cc6e2d3810c)
// Runtime types generated with workerd@1.20260708.1 2026-07-15 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	AI: Ai;
	STAFFING_SOLVER: DurableObjectNamespace<import("./src/index").StaffingSolverContainer>;
	STAFFING_WORKFLOW: Workflow<Parameters<import("./src/index").StaffingProposalWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "StaffingSolverContainer";
	}
