/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 58d04ae008732cf15b9bdf618aff6249)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	OIDC_ISSUER: "https://identity.staging.example.invalid/" | "https://identity.production.example.invalid/" | "https://identity.example.invalid/";
	OIDC_AUDIENCE: "earned-signal-api-staging" | "earned-signal-api-production" | "earned-signal-api-local";
	OIDC_JWKS_URL: "https://identity.staging.example.invalid/.well-known/jwks.json" | "https://identity.production.example.invalid/.well-known/jwks.json" | "https://identity.example.invalid/.well-known/jwks.json";
	MCP_RESOURCE_URL: "https://staging.earned-signal.example.invalid/mcp" | "https://earned-signal.example.invalid/mcp";
	STAFFING_WORKFLOW: Workflow /* StaffingProposalWorkflow from earned-signal-optimizer-staging */ | Workflow /* StaffingProposalWorkflow from earned-signal-optimizer-production */ | Workflow /* StaffingProposalWorkflow from earned-signal-optimizer-local */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		COMPUTE_RATE_LIMIT: RateLimit;
		ASSETS: Fetcher;
		OIDC_ISSUER: "https://identity.staging.example.invalid/";
		OIDC_AUDIENCE: "earned-signal-api-staging";
		OIDC_JWKS_URL: "https://identity.staging.example.invalid/.well-known/jwks.json";
		MCP_RESOURCE_URL: "https://staging.earned-signal.example.invalid/mcp";
		STAFFING_WORKFLOW: Workflow /* StaffingProposalWorkflow from earned-signal-optimizer-staging */;
	}
	interface ProductionEnv {
		...
		COMPUTE_RATE_LIMIT: RateLimit;
		ASSETS: Fetcher;
		OIDC_ISSUER: "https://identity.production.example.invalid/";
		OIDC_AUDIENCE: "earned-signal-api-production";
		OIDC_JWKS_URL: "https://identity.production.example.invalid/.well-known/jwks.json";
		MCP_RESOURCE_URL: "https://earned-signal.example.invalid/mcp";
		STAFFING_WORKFLOW: Workflow /* StaffingProposalWorkflow from earned-signal-optimizer-production */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OIDC_ISSUER" | "OIDC_AUDIENCE" | "OIDC_JWKS_URL" | "MCP_RESOURCE_URL">> {}
}
